...
<nav id="nav_list">
 ...
 <form action="deletemul.php" method="post" id="x" name="form1">
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Sheet" border="10">
            ...
            <tbody>
			  ...
			  while($empres = mysqli_fetch_array($query))
			  {
			   ...
			   ?>
			  <tr>
				<td><input type="checkbox" name="chkbox[]" value="<?php echo @$empres['emp_id'];?>"></td>
          ...
          <br>
          <br>
          <input type="submit" name="del" id="val" value="Delete" style="font-size:18px" align="right" onClick="var e = document.getElementById('x'); e.action='deletemul.php'; e.submit();">
        </form>
 <br>
 <br>
 <br>
